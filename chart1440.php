					...
					<tr><td colspan="4" class="smallhead"><table border="0"><tr><td><img src="/images/25year.gif"></td><td class="smallhead">See our comparison chart below to see that you're not only spending less money per serving than other major brands, but you're also spending a lot less money per actual meal, and per 2000 calories, even with their high percentages of filler servings like drinks and desserts.  <a href="food-storage.php?id=<?php echo $id; ?>">Click here to view our food storage products</a>.</td></tr></table></td></tr>
                ...
                <h1>Compare MaxLife Gourmet Food Storage</h1>
					...
					<tr>
					<td>Package Name</td>
					<td class="focus">8 Serv/Day - 6 Mo.</td>
					<td>Basic 3-Month</td>
