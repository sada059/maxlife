...
<div id="content">
        ...
        <div class="subtop">
            ...
            <ul class="navigation">
                    ...
                    <li>
                    	<a href="food-storage.php?id=<?php echo $id; ?>">LONG-TERM FOOD STORAGE</a>
                    </li>
                    <li>
                    	<a href="supplemental.php?id=<?php echo $id; ?>">ADD-ONS</a>
                    </li>
                    <li>
                    	<a href="camping-food.php?id=<?php echo $id; ?>">SHORT-TERM</a>
                    </li>
                    <li>
...
?>
<table border="0"><tr><td><a href="supplemental.php?id=<?php echo $id; ?>"><img src="http://maxlifefoods.com/images/product/addonthumb.jpg" border="0"></a></td><td><b><a href="supplemental.php?id=<?php echo $id; ?>">CLICK FOR ADD-ON MEAT & RICE, FRUIT, AND VEGETABLES LINES TO ADD EVEN MORE VARIETY AND SECURITY.</a></b></td></tr></table><br><br>
