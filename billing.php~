...
<div id="content">
        ...
        <div class="subbody2" style="height: 1650px;">
			<div class="subbody">
            	...
            	<div class="maincontent">
                    ...
                    <form name="payment" id="payment" method="post" action="https://www.maxlifefoods.com/confirm-order.php?id=<?php echo $id; ?>" onsubmit="return validate()">
                        ...
                        <input type="hidden" name="total" value="<?php echo number_format ($total,2, '.', ''); ?>" />
                                        ...
                                        <fieldset>
                                        	<legend>Billing Information (IMPORTANT: Must match credit card.)</legend>
                                            <ol>
                                                <li>
                                               ...
                                               <li>
                                                ...
                                                <select name="state" required>
                                                    ...
                                                    <option value="AK" <?php if($_SESSION['state'] == 'AK'){echo "selected";} ?>>Alaska (free shipping N/A if AK shipping address)</option>
                                                    ...
                                                    <option value="HI" <?php if($_SESSION['state'] == 'HI'){echo "selected";} ?>>Hawaii (free shipping N/A if HI shipping address)</option>
                                ...
                                <fieldset>
                                    <legend>Contact Information</legend>
                                        	...
                                        	<legend>Shipping Information (leave blank if same)</legend>
                                            <ol>
                                                <li>
                                                <label for=ship_fname>First Name</label>
                                                <input id=ship_fname name=ship_fname type=text placeholder="First name" value="<?php echo $_SESSION['ship_fname']; ?>" autofocus>
                                                </li>
                                                <li>
                                                <label for=ship_lname>Last Name</label>
                                                <input id=ship_lname name=ship_lname type=text placeholder="Last name" value="<?php echo $_SESSION['ship_lname']; ?>">
                                                </li>
                                                <li>
                                                <label for=ship_address>Street</label>
                                                <input id=ship_address name=ship_address type=text placeholder="123 Main St" value="<?php echo $_SESSION['ship_address']; ?>">
                                                </li>
                                                <!--<li>
                                                ...
                                                <input id=ship_city name=ship_city type=text placeholder="City" value="<?php echo $_SESSION['ship_city']; ?>">
                                                </li>
                                                <li>
                                                ...
                                                <input id=ship_zip name=ship_zip type=text placeholder="Zip Code" value="<?php echo $_SESSION['ship_zip']; ?>">
                                                </li>
                                            </ol>
                                </fieldset>
                                <fieldset>
                                    <legend>Card Details</legend>
                                    	<ol>
                                            ...
                                            <input id=ccnum maxlength="16" name=ccnum type=text value="<?php echo $_SESSION['ccnum']; ?>" required> <font size="2" color="#000000">(No spaces or dashes)</font>
                                            </li>
                                            <li>
                                            ...
                                            <select id="ccexp2" name="ccexp2" required>
                                                ...
                                                <option value="23" <?php if($_SESSION['ccexp2'] == '23'){echo "selected";} ?>>2023</option>
                                                <option value="24" <?php if($_SESSION['ccexp2'] == '24'){echo "selected";} ?>>2024</option>
                                                <option value="25" <?php if($_SESSION['ccexp2'] == '25'){echo "selected";} ?>>2025</option>
                                                <option value="26" <?php if($_SESSION['ccexp2'] == '26'){echo "selected";} ?>>2026</option>
                                            </select>
                                            </li>
                                            <li>
