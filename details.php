			...
			<div class="subbody">
               ...
               <?php if ($info['showmenu'] == 'protein'){  
                    ...
                    <tr>
                        <td>&nbsp;</td><td>&nbsp;</td>                       
                        <td style="vertical-align: text-top;">
                        	<a href="nutrition.php?i=protein"><img border="0" src="/images/menu/protein_m.jpg" alt="" /><br />Protein Drink</a><br>(<?php echo $num_servings ?> servings)<br /><br />
                        </td>
                        <td>&nbsp;</td><td>&nbsp;</td>                    
                    </tr>
               ...
               <?php if ($info['showmenu'] == 'beef'){  
                ...
                <?php if ($info['showmenu'] == 'fruitreg' or $info['showmenu'] == 'maxlifefruit' or $info['showmenu'] == 'maxlifeveggiefruit' or $info['showmenu'] == 'maxlifeveggiefruit2'){  
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: text-top;text-align:center;" colspan="5">
                        	<a href="nutrition.php?i=fruit_maxlife"><img border="0" src="/images/menu/fruit_maxlife.jpg" alt="" /><br />Freeze-Dried Fruit Mix</a><br /><br />
                        </td>
                ...
                <?php if ($info['showmenu'] == 'gluten'){   
                    			$num_low_servings = $info['servings'] / 7; 
                    			$num_high_servings = $info['servings'] / 5.25;  
                    			$num_higher_servings = $info['servings'] / 3; ?>

								<?php include_once('menu_gluten.php') ?>
