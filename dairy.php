<?php
	...
	$query = "SELECT * FROM products WHERE product_category='7' and active = 1 ORDER BY product_appear_order ASC";
...
<div class="container heading-blue">
        <div class="row">
            <div class="col-md-6" style="padding: 0"> <h2>Add-Ons - Protein Drinks & Milk</h2></div>
...
<section>
    <div class="container">
        <div class="row">
                    <p>
                Add PROTEIN DRINKS & MILK to your long-term food storage.  Add-Ons are not meant to be the main source of food storage, but to help customize your food storage to your personal tastes.</p>
