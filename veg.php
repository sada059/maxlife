<?php
	...
	$query = "SELECT * FROM products WHERE product_category='6' and active = 1 ORDER BY product_appear_order ASC";
...
<?php include_once("includes/header.php") ?>
    <div class="container heading-blue">
        <div class="row">
            <div class="col-md-6" style="padding: 0"> <h2>Add-Ons - Vegetables</h2></div>
...
<section>
    <div class="container">
        <div class="row">
                    <p>
                Add VEGETABLES to your long-term food storage.  Add-Ons are not meant to be the main source of food storage, but to help customize your food storage to your personal tastes.</p>
                <br>
    ...
    while($info = mysql_fetch_assoc($run)){
        ...
        ?>
            ...
            <div class="col-md-9">
                <div class="row">
                <div class="col-md-10">
                    <h2><a href="details.php?id=<?php echo $id; ?>&pid=<?php echo $info['product_key']; ?>"><?php echo $info['product_name2']; ?></a> <?php if ($info['product_key'] == '963852' || $info['product_key'] == '820741'){ }else {$number = $pps; setlocale(LC_MONETARY, 'en_US'); echo "<!--- ".money_format('%(#10n', $number)."/Ea-->"; } ?><br />
                        <p style="font-size: 12px; margin-top: -2px; text-indent: 40px;"><?php if ($info['product_key'] == '963852' || $info['product_key'] == '820741'){ echo "&nbsp;"; }else { echo $info['servings']." Servings"; } ?></p>
                        
                        <div class="col-md-2 product-price"><a href="details.php?id=<?php echo $id; ?>&pid=<?php echo $info['product_key']; ?>"></div>
                            <p class="viewDetails" style="margin-top: -40px;"><?php $number = $info['product_price']; setlocale(LC_MONETARY, 'en_US'); $number2 = money_format('%(#10n',$number * 1.4); echo money_format('%(#10n', $number); if ($number > 100) echo "<!--<br><font style='font-size: 14px;'>Competitors: <del> $number2 </del></font>-->"; ?></p></a></h2>
                     </div>
                </div><p>
                    <?php
                    $position = 83;
