...
<?php include_once("header.php") ?>
        ...
        <div class="subbody2" style="height: 2000px;">
			<div class="subbody">
...
<br>
					...
					<br /><br />Sample our fruit mix, apple blueberry granola, hearty potato soup & cheddar broccoli soup.  Sample pack of the MaxLife Basic and Deluxe entree/breakfast line. LIMIT ONE PER CUSTOMER. 25 year shelf life.</td></tr>
					</table>
					<!--<table align="center" border="0" cellpadding="10" cellspacing="10">
						<tr>
                    	<td style="vertical-align: text-top;">
